...
import { item6, item7, item8 } from "../../Konga";

export default function ComputerPeripherals(props) {
  const products = ServeGroupItems("ComputerPeripherals");
  console.log(ServeGroupItems("ComputerPeripherals"))

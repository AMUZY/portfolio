...
export default function Home(props) {
    const vendors = [
        ...
        // {name : "EXPERTNAIRE" , src : expertnaire , href : "/expertnaire",  alt : "expertnaire, platform for digital products"},
    ]
                ...
                <div className="my-5 flex justify-center flex-col xl:flex-row xl:flex-wrap xl:w-full">
                    {
                        vendors.map((item)=>{
                            return (
                                <div className = "vendor p-3 m-5 white_col icon_shadow xl:mx-auto"
                                    key = {uuidv4()}>
                                    {/* VENDOR NAME */}
